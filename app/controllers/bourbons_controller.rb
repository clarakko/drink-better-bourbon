class BourbonsController < ApplicationController
  ...
  def show
    ...
    @user_rating = @reviews.average(:rating).to_i
  ...
  def create
    ...
    if @bourbon.save
      ...
      $twitter.update(
        "New bourbon added! Check out the review for #{@bourbon.name} at http://drinkbetterbourbon.herokuapp.com/bourbons/#{@bourbon.id}"
      )
